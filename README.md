...
5. Open a terminal (e.g. Command Prompt or PowerShell) in the same folder as `election_counting_machine.py` and run the script by typing `python election_counting_machine.py` into the terminal and pressing ENTER.
